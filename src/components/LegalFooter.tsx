...
const PrivacyPolicy = () => (
  <SectionShell title="Privacy Policy">
    ...
    <p><strong className="text-foreground">4. Third-Party Processors.</strong> NOWPayments (card & crypto settlement), Ondato (identity verification), Supabase (database/auth/storage). All processors are bound by data processing agreements.</p>
...
const RefundPolicy = () => (
  <SectionShell title="Refund & Cancellation Policy">
    ...
    <p><strong className="text-foreground">Card Disputes.</strong> Card-payment refunds are issued by <strong className="text-foreground">NOWPayments</strong> back to the original payment method, typically within 5–10 business days. Crypto payments are non-reversible by nature; refunds (if approved) are returned in LTC to the originating wallet.</p>
...
const Complaints = () => (
  <SectionShell title="Complaints Procedure">
    ...
    <p><strong className="text-foreground">Step 3 — Payment Processor Disputes.</strong> Card & crypto payment complaints not resolved by us may be escalated to <strong className="text-foreground">NOWPayments</strong> support at <a href="mailto:support@nowpayments.io" className="text-primary hover:underline">support@nowpayments.io</a>.</p>
...
const ContactInfo = () => (
  <SectionShell title="Contact Us">
    ...
    <p className="text-muted-foreground/60 text-[10px]">Payment processor: NOWPayments — support@nowpayments.io</p>
  </SectionShell>
);
